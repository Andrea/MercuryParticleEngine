...
namespace ProjectMercury.Modifiers
{
    ...
    abstract public class Modifier
    {
        ...
        public virtual void ProcessReleasedParticle(float totalTime, ref Particle particle) { }
        ...
        public virtual void ProcessActiveParticle(float totalTime, float elapsedTime, ref Particle particle, float age) { }
        ...
        public virtual void ProcessRetiredParticle(float totalTime, ref Particle particle) { }
    }
}
