...
namespace ProjectMercury
{
    ...
    public class ParticleEffect : DrawableGameComponent, ISerializable
    {
        ...
        /// <param name="renderer">The renderer which will be used to render the effect.</param>
            ...
            : base(MercuryLoader.GameReference)
        {
            ...
            this._emitters = info.GetValue("_emitters", typeof(List<Emitter<Particle>>)) as List<Emitter<Particle>>;
        ...
        private List<Emitter<Particle>> _emitters = new List<Emitter<Particle>>();          //Emitters which are part of the effect.
        ...
        /// </summary>
        public IList<Emitter<Particle>> Emitters
        {
