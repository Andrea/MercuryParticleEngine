...
namespace ProjectMercury.ContentPipeline.Modifiers
{
    ...
    /// and deserializing TriggerOffsetController objects.
    /// </summary>
    [ContentTypeSerializer]
    public sealed class TriggerOffsetControllerSerializer : ContentTypeSerializer<TriggerOffsetController>
    {
        /// <summary>
        ...
        protected override void Serialize(IntermediateWriter output, TriggerOffsetController value, ContentSerializerAttribute format)
        {
            output.WriteObject("TriggerOffset", value.TriggerOffset);
        }

        /// <summary>
        /// Deserializes a TriggerOffsetController object from intermediate XML format.
        /// </summary>
        ...
        /// <returns>A deserialized TriggerOffsetController instance.</returns>
        protected override TriggerOffsetController Deserialize(IntermediateReader input, ContentSerializerAttribute format, TriggerOffsetController existingInstance)
        {
            TriggerOffsetController value = existingInstance ?? new TriggerOffsetController();

            value.TriggerOffset = input.ReadObject<Vector3>("TriggerOffset");
