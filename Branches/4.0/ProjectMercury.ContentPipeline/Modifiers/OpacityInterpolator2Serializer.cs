...
namespace ProjectMercury.ContentPipeline.Modifiers
{
    ...
    /// and deserializing OpacityInterpolator2 objects.
    /// </summary>
    [ContentTypeSerializer]
    public sealed class OpacityInterpolator2Serializer : ContentTypeSerializer<OpacityInterpolator2>
    {
        /// <summary>
        ...
        protected override void Serialize(IntermediateWriter output, OpacityInterpolator2 value, ContentSerializerAttribute format)
        {
        ...
        /// <summary>
        /// Deserializes a OpacityInterpolator2 object from intermediate XML format.
        /// </summary>
        ...
        /// <returns>A deserialized OpacityInterpolator2 instance.</returns>
        protected override OpacityInterpolator2 Deserialize(IntermediateReader input, ContentSerializerAttribute format, OpacityInterpolator2 existingInstance)
        {
            OpacityInterpolator2 value = existingInstance ?? new OpacityInterpolator2();
