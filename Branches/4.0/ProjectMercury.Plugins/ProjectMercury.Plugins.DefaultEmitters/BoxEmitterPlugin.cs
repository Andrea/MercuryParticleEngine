...
namespace ProjectMercury.Plugins.DefaultEmitters
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the box emitter.
    /// </summary>
    [Export(typeof(IEmitterPlugin))]
    public sealed class BoxEmitterPlugin : IEmitterPlugin
    {
        /// <summary>
        ...
        {
            get { return "An emitter which releases particles from within a axis aligned box."; }
        }
