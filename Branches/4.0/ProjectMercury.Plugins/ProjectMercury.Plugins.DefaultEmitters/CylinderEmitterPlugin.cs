...
namespace ProjectMercury.Plugins.DefaultEmitters
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the cylinder emitter.
    /// </summary>
    [Export(typeof(IEmitterPlugin))]
    public sealed class CylinderEmitterPlugin : IEmitterPlugin
    {
        /// <summary>
        ...
        {
            get { return "An emitter which releases particles from within a cylinder."; }
        }
