...
namespace ProjectMercury.Plugins.DefaultControllers
{
    ...
    /// <summary>
    /// Defines an controller plugin which provides access to the CooldownController.
    /// </summary>
    [Export(typeof(IControllerPlugin))]
    public sealed class CooldownControllerPlugin : IControllerPlugin
    {
        /// <summary>
        ...
        public String Name
        {
            get { return "Cooldown Controller"; }
        }
        ...
        {
            get { return "A controller which adds a minimum trigger period to an emitter."; }
        }
