...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the SphereForceModifier class.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class SphereForceModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        public String Name
        {
            get { return "Sphere Force Modifier"; }
        }
        ...
        {
            get { return "A modifier which applies a force vector to particles when they enter a spherical area."; }
        }
