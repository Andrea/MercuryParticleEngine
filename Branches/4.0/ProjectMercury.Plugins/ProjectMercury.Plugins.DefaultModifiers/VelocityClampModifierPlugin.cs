...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the VelocityClampModifier class.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class VelocityClampModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A modifier which restricts the velocity of particles to a defined maximum."; }
        }
