...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the OpacityInterpolator3 modifier.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class OpacityInterpolator3Plugin : IModifierPlugin
    {
        /// <summary>
        ...
        public String Name
        {
            get { return "Opacity Interpolator (3 values)"; }
        }
