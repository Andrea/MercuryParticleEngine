...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the HueShiftModifier class.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class HueShiftModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A modifier which changes the colour of particles by adjusting the hue."; }
        }
