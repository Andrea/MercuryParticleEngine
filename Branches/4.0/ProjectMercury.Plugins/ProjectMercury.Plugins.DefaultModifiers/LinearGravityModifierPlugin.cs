...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the LinearGravityModifier class.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class LinearGravityModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A modifier which applies a linear gravity force to particles."; }
        }
