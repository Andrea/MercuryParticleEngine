...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the DampingModifier class.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class DampingModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A modifier which applies a damping force to particles."; }
        }
