...
namespace ProjectMercury.Plugins.DefaultModifiers
{
    ...
    /// <summary>
    /// Defines an emitter plugin which provides access to the ScaleInterpolator2 modifier.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public sealed class ScaleInterpolator2Plugin : IModifierPlugin
    {
        /// <summary>
        ...
        public String Name
        {
            get { return "Scale Interpolator (2 values)"; }
        }
