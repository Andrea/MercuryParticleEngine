...
namespace ProjectMercury.Design.Modifiers
{
    ...
    /// <summary>
    /// Defines the custom type descriptor for the velocity clamp modifier class.
    /// </summary>
    public sealed class VelocityClampModifierTypeDescriptor : AbstractTypeDescriptor<VelocityClampModifier>
    {
        private readonly Type ModifierType = typeof(VelocityClampModifier);
