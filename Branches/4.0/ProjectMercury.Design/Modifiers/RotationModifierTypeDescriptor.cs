...
namespace ProjectMercury.Design.Modifiers
{
    ...
    /// <summary>
    /// Defines the custom type descriptor for the rotation modifier class.
    /// </summary>
    public sealed class RotationModifierTypeDescriptor : AbstractTypeDescriptor<RotationModifier>
    {
        private readonly Type ModifierType = typeof(RotationModifier);
