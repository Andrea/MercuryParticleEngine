...
namespace ProjectMercury.Design.Modifiers
{
    ...
    /// <summary>
    /// Defines the custom type descriptor for the hue shift modifier class.
    /// </summary>
    public sealed class HueShiftModifierTypeDescriptor : AbstractTypeDescriptor<HueShiftModifier>
    {
        private readonly Type ModifierType = typeof(HueShiftModifier);
