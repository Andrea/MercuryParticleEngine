...
namespace ProjectMercury.Design
{
    ...
    /// <summary>
    /// Defines the type converter for the colour range structure.
    /// </summary>
    internal sealed class ColourRangeTypeConverter : ExpandableObjectConverter
    {
        static private readonly Type RangeType = typeof(ColourRange);
