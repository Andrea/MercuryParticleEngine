...
namespace ProjectMercury.Design.Controllers
{
    ...
    /// <summary>
    /// Defines the custom type descriptor for the trigger offset controller class.
    /// </summary>
    public sealed class TriggerOffsetControllerTypeDescriptor : AbstractTypeDescriptor<TriggerOffsetController>
    {
        private readonly Type ControllerType = typeof(TriggerOffsetController);
