...
namespace ProjectMercury.Design
{
    ...
    /// <summary>
    /// Defines the type converter for the rotation range structure.
    /// </summary>
    internal sealed class RotationRangeTypeConverter : ExpandableObjectConverter
    {
        static private readonly Type RangeType = typeof(RotationRange);
